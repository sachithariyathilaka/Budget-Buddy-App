...
public class ReportActivity extends AppCompatActivity {
    ...
    private void loadReportData() {
        ...
        String reportText = "Total: " + String.valueOf(dbHelper.getTotal(s, e)) +
                ...
                "Rs\nMax profit: " + String.valueOf(dbHelper.getMAXProfit(s, e)) + "Rs";
    ...
    private boolean createPdf() {
        ...
        try {
            ...
            arrayStringReport.add("Total: " + String.valueOf(dbHelper.getTotal(start, end)) + "Rs");
            arrayStringReport.add("Total expense " + String.valueOf(dbHelper.getTotalExpense(start, end)) + "Rs");
            arrayStringReport.add("Total profit: " + String.valueOf(dbHelper.getTotalProfit(start, end)) + "Rs");
            arrayStringReport.add("Averange expense: " + String.valueOf(dbHelper.getAVGExpense(start, end)) + "Rs");
            arrayStringReport.add("Averange profit: " + String.valueOf(dbHelper.getAVGProfit(start, end)) + "Rs");
            arrayStringReport.add("Min expense: " + String.valueOf(dbHelper.getMINExpense(start, end)) + "Rs");
            arrayStringReport.add("Max profit: " + String.valueOf(dbHelper.getMAXProfit(start, end)) + "Rs");
