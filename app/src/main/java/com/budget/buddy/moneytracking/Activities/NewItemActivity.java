...
import com.budget.buddy.moneytracking.Adapters.PlaceAdapter;
import com.budget.buddy.moneytracking.Database.DBHelper;
import com.budget.buddy.moneytracking.Entities.Category;
import com.budget.buddy.moneytracking.Entities.Location;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        paste.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                amountAdd.setText(item.getText().toString());
            }
        });
